...
namespace Web.admin.business
{
    public partial class AgentList : AdminPageBase//System.Web.UI.Page
    {
        ...
        private void bind2()
        {
            bind_repeater(GetAgentList1(getWhere2()), Repeater2, "OpenTime desc", tr1, AspNetPager2);
        }
        ...
        {
            DataSet ds = GetAgentList1(getWhere2());//获取信息
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    {
                        filename = dte.DataExcel(newTable, "已开通服务网点", FilePath, nameList);
                    }
                }
                catch
                {
