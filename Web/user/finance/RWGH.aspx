<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/user/index.Master"  CodeBehind="RWGH.aspx.cs" Inherits="Web.user.finance.RWGH" %>
                            ...
                            <div class="form-horizontal col-sm-12">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <label class="col-md-2 control-label">申请人文关怀金额：</label>
                                        <div class="col-md-10">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group"  id="divOutAccount" runat="server" >
                                        <label class="col-md-2 control-label"><asp:Label ID="lblOutAccountTitle" runat="server">账号</asp:Label>：</label>
                                        <div class="col-md-10">
                                    ...
                                    <label class="col-md-2 control-label"><asp:Label runat="server">备注</asp:Label>：</label>
                                    <div class="col-md-10">
                                        <asp:TextBox ID="txtPubContext"  maxlength="100" runat="server" tip="输入内容" class="form-control" Height="180px"   TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                    </div>
                                                ...
                                                <tr class="<%# (this.Repeater1.Items.Count + 1) % 2 == 0 ? "odd":"even"%>">
                                                    ...
                                                    <td data-title="操作">
                                                        ...
                                                        <asp:LinkButton ID="lbtnCancel" runat="server" class="btn btn-danger btn-sm del-alert" CommandName="change" Visible='<%#Eval("Flag").ToString() == "0" ? true : false%>'
                                                            CommandArgument='<%#Eval("ID")%>' OnClientClick="return confirm('确认取消吗？')">取消<!--取消提现--></asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
